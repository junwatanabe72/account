    ...
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="row g-2 mb-2">
          <div className="col-md-5"><small className="text-muted">借方科目</small></div>
          <div className="col-md-2"><small className="text-muted">借方金額</small></div>
          <div className="col-md-5"><small className="text-muted">貸方科目</small></div>
          ...
          <div key={idx} className="row g-2 align-items-center mb-2">
            <div className="col-md-5">
              <HierarchicalAccountSelect
                accounts={accounts}
                value={r.debit ?? ''}
                onChange={(value) => setRows((rs) => rs.map((x, i) => i === idx ? { ...x, debit: value } : x))}
                placeholder="借方科目を選択"
              />
            </div>
            ...
            <div className="col-md-5">
              <HierarchicalAccountSelect
                accounts={accounts}
                value={r.credit ?? ''}
                onChange={(value) => setRows((rs) => rs.map((x, i) => i === idx ? { ...x, credit: value } : x))}
                placeholder="貸方科目を選択"
              />
            </div>
            <div className="col-md-2">
