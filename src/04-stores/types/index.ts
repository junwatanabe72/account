...
// BankAccountService, TransferService are not migrated yet
...
import { Transaction, TransactionInput } from '../../../01-types/transaction'
import { Journal, JournalEntry } from '../../01-types/accounting'
