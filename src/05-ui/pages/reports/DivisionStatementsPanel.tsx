...
// } from '../../../01-types/accountingDivision'

// Temporary definitions to avoid import errors
interface AccountingDivision {
  code: string
  name: string
  level: number
}

const DEFAULT_ACCOUNTING_DIVISIONS: AccountingDivision[] = []
const getGroupedAccountingDivisions = (divisions?: any) => ({ income: [], expense: [] })
const TOP_LEVEL_NAMES = { income: '収入の部', expense: '支出の部' }
const LEGACY_DIVISION_MAPPING = { KANRI: '管理', SHUZEN: '修繕' }
