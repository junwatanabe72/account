/**
 * @fileoverview Freee風仕訳入力フォーム
 * @module ui/transactions/FreeeStyleJournalForm
 * @description
 * Freeeの操作感を模した仕訳入力フォームコンポーネントです。
 * 収入・支出・振替の3タイプの取引を直感的に入力できます。
 * 
 * @責務
 * - 仕訳データの入力UI提供
 * - 入力データのバリデーション表示
 ...
 * 
 * @注意
 * - ビジネスロジックは含まない（Storeに委譲）
 * - バリデーションロジックはサービス層で実行
 * 
 * @更新履歴
 * - 2024-11-17: ファイルヘッダー追加
 */
...
import {
  ...
  AccountItem,
  AccountCategory,
} from "../../../01-types/accountCategories";
import {
  defaultBankAccounts,
  BankAccount,
  getTransferableCombinations,
} from "../../../06-data/static/bankAccounts";
